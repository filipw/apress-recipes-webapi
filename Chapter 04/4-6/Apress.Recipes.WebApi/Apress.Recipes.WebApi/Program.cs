    ...
    class Program
    {
        static void Main()
        {
            ...
            using (WebApp.Start<Startup>(address))
            {
                ...
                var meesage1 = new HttpRequestMessage(HttpMethod.Get, address + "values");
                ...
                var meesage2 = new HttpRequestMessage(HttpMethod.Get, address + "values");
                meesage2.Headers.Accept.Add(new MediaTypeWithQualityHeaderValue("application/rss+xml"));
